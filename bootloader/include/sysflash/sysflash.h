...
#define ALL_AVAILABLE_SLOTS FLASH_AREA_IMAGE_0_SLOTS, FLASH_AREA_IMAGE_1_SLOTS
#elif (MCUBOOT_IMAGE_NUMBER == 3)
#define ALL_AVAILABLE_SLOTS                                                    \
    FLASH_AREA_IMAGE_0_SLOTS, FLASH_AREA_IMAGE_1_SLOTS, FLASH_AREA_IMAGE_2_SLOTS
#endif

static inline uint32_t
__flash_area_ids_for_slot(int img, int slot)
{
