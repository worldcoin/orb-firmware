...
#define FLASH_AREA_IMAGE_PRIMARY(x)                                            \
    (((x) == 0) ? FLASH_AREA_ID(image_0) : FLASH_AREA_ID(image_0))
#define FLASH_AREA_IMAGE_SECONDARY(x)                                          \
    (((x) == 0) ? FLASH_AREA_ID(image_1) : FLASH_AREA_ID(image_1))
 ...
 */
#define FLASH_AREA_IMAGE_PRIMARY(x)                                            \
    (((x) == 0)   ? FLASH_AREA_ID(image_0)                                     \
     : ((x) == 1) ? FLASH_AREA_ID(image_2)                                     \
                  : 255)
#define FLASH_AREA_IMAGE_SECONDARY(x)                                          \
    (((x) == 0)   ? FLASH_AREA_ID(image_1)                                     \
     : ((x) == 1) ? FLASH_AREA_ID(image_3)                                     \
                  : 255)
#else
