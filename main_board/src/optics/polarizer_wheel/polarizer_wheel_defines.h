...
/* Following is a calculation how to arrive at different PWM frequencies and step counts
 * for the polarizer wheel application.
 * Motor Used: 26M048B1B, datasheet found here: https://www.digikey.de/en/products/detail/portescap/26M048B1B/417812
 * Motor Driver used: DRV8434
 * Motor Step Angle: 7.5 degrees
 * Microstepping configured in DRV8434: 1/128
 * Calculation: (360 degrees / 7.5 degrees per step) * 128 (microsteps) = 6144 steps/rev
 * 6144 steps/rev / 3 = 2048 steps per filter wheel position
 * For Auto-homing, we can move slow, 
 * To move 120 degrees in 1.5 seconds, PWM frequency = 2048 / 1.5 = 1365.33 Hz
 * 
 */
...
// This is intentionally set slightly higher than the max steps needed to move 120 degrees
// to account for any potential errors in the step count
#define POLARIZER_WHEEL_STEPS_AUTOHOMING                      2200

// Number of correction steps to issue after homing is complete and last notch is found
