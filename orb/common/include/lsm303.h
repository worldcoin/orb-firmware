...
/** @defgroup Acc_Block_Data_Update
  * @{
  */
#define LSM303DLHC_BlockUpdate_Continuous   ((uint8_t)0x00) /*!< Continuous Update */
...
/// \param fifo_full_cb Set callback to be called when new data is ready. Function called from interrupt context.
void
