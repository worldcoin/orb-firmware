...
FW_APP_Run(void)
{
    ...
    while (1U)
    {
        ...
        if (COM_Receive(&key, 1U, RX_TIMEOUT) == HAL_OK)
        {
            switch (key)
            {
                case '1' :FW_UPDATE_Run();
                    break;
                case '2' :TEST_PROTECTIONS_RunMenu();
                    break;
                case '3' :SE_USER_CODE_RunMenu();
                    break;
                case '4' :FW_UPDATE_MULTIPLE_RunMenu();
                    break;
                case '5' :FW_VALIDATE_RunMenu();
                    break;
                default:printf("Invalid Number !\r");
                    break;
            }
