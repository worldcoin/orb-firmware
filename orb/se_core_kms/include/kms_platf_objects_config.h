...
static const kms_obj_keyhead_30_t   KMS_Blob_ECDSA_Verify =
{
  ...
  1,                               /*  uint32_t object_id */
  {
    ...
    CKA_EC_POINT,     67, 0x04410450U, 0x9c68b309U, 0x4a6856cdU, 0xddd8e8acU, 0x5a68fd6fU, 0x98f52bb0U, 0x54f4011eU, 0x83b69888U, 0x2962e168U, 0x9170a963U, 0x3f37a505U, 0xe4059536U, 0x129e1025U, 0x123c7283U, 0x797dfd5dU, 0x88175f5aU, 0x334a09U,
  }
};
