...
#define SOUND_AMP_MUX_FLAGS DT_GPIO_FLAGS(SOUND_AMP_MUX_NODE, sound_amp_mux_gpios)
...
int init_sound(void)
{
    ...
    if (gpio_pin_configure(sound_mux, SOUND_AMP_MUX_PIN, SOUND_AMP_MUX_FLAGS | GPIO_OUTPUT)) {
